...
public class LoginPageTest extends PageBase  {
    public LoginPageTest(CustomWebDriver driver, String url, String email, String password) {
    ...
    public boolean isDisplayed() {
        ...
        return CheckIfElement.isDisplayed(CustomBy.xpath("//*[@id=\"inputEmail\"]"), driver);
    }
}
