...
public class ChangelogPage extends PageBase {
    public ChangelogPage(CustomWebDriver driver, String url, String email, String password) {
    ...
    public boolean isDisplayed() {
        return CheckIfElement.isDisplayed(CustomBy.xpath("//*[@id=\"header-title\"]"), driver);
    }
}
